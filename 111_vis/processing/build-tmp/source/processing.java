...
public void draw() {
    ...
    if(sketcht == 1 || sketcht == 2) {
        ...
        for(TableRow row : table.rows()) {
            ...
            for(int i = 1; i <= 44; i++) {
                ...
                fill(100-u*10,155 + u*10,y*-0.2f, u*40);
    ...
    if(sketcht == 2 || sketcht == 3 || sketcht == 4) {
        ...
        for(int i = 1; i <= 44; i++) {
            ...
            // stroke(#f2f1ed);
            // strokeWeight(3);
            rect(i*s, (-s*min*2 +s)  -(s*(max-min)*1) * (1 - 0.01f * min(100, frames)), i*s + 18,  (-s*max*2 -s) +(s*(max-min)*1) * (1 - 0.01f * min(100, frames)));
    ...
    if(sketcht == 3 || sketcht == 4) {
        ...
        float s = width/11.25f;
        float sy = width/54;
        textAlign(CENTER);
        translate(1.17f*s,16*sy +170);
